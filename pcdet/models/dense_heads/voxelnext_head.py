...
from ..model_utils import centernet_utils_voxelnext as centernet_utils
from ..model_utils import model_nms_utils
from ...utils import loss_utils_voxelnext as loss_utils
...
class VoxelNeXtHead(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        # print('######x.shape:', x[0].spatial_shape.shape)
        # print('######x.indices:', x[0].indices[:10])
        # print('#####features.shape:', x.features.shape)
        # print('#####spatial_shape:', x.spatial_shape)
