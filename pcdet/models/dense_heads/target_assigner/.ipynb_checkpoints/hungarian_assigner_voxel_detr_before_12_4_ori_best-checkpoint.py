...
class HungarianMatcher3d(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        if self.use_iou and 'pred_ious' in outputs.keys():
            out_iou = pred_iou 
#             out_iou = (pred_iou + 1.0)/2.0 #### zliu 2023.10.18
            # print('####use 1/2 iou hungarian!!!!')
