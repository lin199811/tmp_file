...
def random_global_rotation_xy(gt_boxes, points, rot_range, return_rot=False, noise_rotation_x=None, noise_rotation_y=None):
    """
    Args:
        gt_boxes: (N, 7 + C), [x, y, z, dx, dy, dz, heading, [vx], [vy]]
        points: (M, 3 + C),
